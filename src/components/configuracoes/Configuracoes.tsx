...
const Configuracoes: React.FC = () => {
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!window.confirm("ATENÇÃO: Restaurar um backup irá sobrescrever TODOS os dados atuais do banco de dados. Deseja continuar?")) {
      e.target.value = "";
      return;
    }
    ...
    try {
      setIsImporting(true);
      toast.info("Restaurando backup... Aguarde.", { autoClose: false, toastId: "restoring" });
    ...
    <div className="page-container">
      ...
      <div className="section">
        ...
        <p style={{ marginBottom: "1rem", color: "var(--text-secondary)" }}>
          Gere um arquivo .bak contendo todos os dados do sistema ou restaure a partir de um arquivo previamente exportado.
        </p>
